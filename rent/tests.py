...
class RentAppTestCase(TestCase):
    ...
    def test_validate_date_gt_max_limit(self):
        with self.assertRaises(ValidationError):
            ...
            RentBusinessLogic.validate_date_gt_max_limit(date1, date2, "test")

    def test_validate_date1_gr_or_eq_date2(self):
        with self.assertRaises(ValidationError):
            date1 = date(year=2022, month=1, day=1)
            date2 = date(year=2022, month=1, day=1)
            RentBusinessLogic.validate_date1_gr_or_eq_date2(date1, date2,
                                                            "test")
    ...
    def test_validate_date1_eq_or_low_date2(self):
        with self.assertRaises(ValidationError):
            date1 = date(year=2022, month=1, day=1)
            date2 = date(year=2022, month=1, day=1)
            RentBusinessLogic.validate_date1_eq_or_low_date2(date1, date2,
                                                             "test")
    ...
    def test_validate_amount_update(self):
        with self.assertRaises(ValidationError):
            RentBusinessLogic.validate_amount_update(self.amount, self.film2,
                                                     self.rent1)
    ...
    def test_validate_state_close(self):
        with self.assertRaises(ValidationError):
            RentBusinessLogic.validate_state_close('close', None)
    ...
    def test_validate_update_permission(self):
        with self.assertRaises(ValidationError):
            RentBusinessLogic.validate_update_permission('close')
